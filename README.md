...
- tshell currently supports password login only. Private key login is not implemented.
- Do not write plaintext passwords into the JSON file. Add or edit the server from the UI if you want tshell to generate `encryptedPassword`.
